...
import (
	...
	"github.com/DharitriNetwork/dharitri-go/data/transaction"
	"github.com/DharitriNetwork/dharitri-sdk-erdgo"
	"github.com/DharitriNetwork/dharitri-sdk-erdgo/blockchain"
	"github.com/DharitriNetwork/dharitri-sdk-erdgo/data"
)
...
func NewBlockchainInteractor(chainInfo config.BlockchainConfig) (*BlockchainInteractor, error) {
	...
	proxy := blockchain.NewDharitriProxy(chainInfo.ProxyUrl, &http.Client{})
